...
export default function Finish() {
  ...
  return (
    <Zone style={{ flex: 1 }}><SafeAreaView style={{ flex: 1, padding: 24 }}>
      ...
      <View style={{ flex: 1 }} />
      <TextInput value={note} onChangeText={setNote} placeholder="Add a note for this session" placeholderTextColor={color.t3} multiline style={[field, { minHeight: 52, paddingVertical: 14, marginBottom: 16 }]} />
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 32 }}>
        <Pressable onPress={() => router.back()} style={{ paddingVertical: 14 }}><Body tone="t2">Back</Body></Pressable>
        <Pressable onPress={onDiscard} style={{ paddingVertical: 14 }}><Body tone="t2">Discard</Body></Pressable>
      </View>
    </SafeAreaView></Zone>
  );
}
